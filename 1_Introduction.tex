...
Paralelamente se buscar estudiar la sensibilidad del programa y en particular de los m\'etodos de filtro de Kalman en un escenario donde hay p\'erdida de informaci\'on.
